...
public typealias RadianCoordinate2D = TurfRadianCoordinate2D
#endif

/**
 A coordinate pair measured in radians, as opposed to `TurfLocationCoordinate2D`, which is measured in degrees of arc.
 */
public struct TurfRadianCoordinate2D: Sendable {
     ...
     */
    public init(_ degreeCoordinate: TurfLocationCoordinate2D) {
     ...
     */
    public func direction(to coordinate: TurfRadianCoordinate2D) -> Measurement<UnitAngle> {
     ...
     */
    public func coordinate(at distance: RadianDistance, facing direction: Measurement<UnitAngle>) -> TurfRadianCoordinate2D {
        ...
        return TurfRadianCoordinate2D(latitude: otherLatitude, longitude: otherLongitude)
    }
    
    /**
     Returns the Haversine distance between two coordinates measured in radians.
     */
    public func distance(to coordinate: TurfRadianCoordinate2D) -> RadianDistance {

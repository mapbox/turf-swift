...
[![Documentation](https://mapbox.github.io/turf-swift/2.5.0/badge.svg)](https://mapbox.github.io/turf-swift/) &nbsp;&nbsp;&nbsp;
...
```swift
.package(url: "https://github.com/mapbox/turf-swift.git", from: "2.5.0")
```

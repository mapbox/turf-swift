...
class LocationCoordinate2DTests: XCTestCase {
    ...
    func testCalculatesDirection() {
        let startCoordinate = TurfLocationCoordinate2D(latitude: 35, longitude: 35)
        let endCoordianate = TurfLocationCoordinate2D(latitude: -10, longitude: -10)
    ...
    func testCalculatesCoordinateFacingDirectionInDegrees() {
        let startCoordianate = TurfLocationCoordinate2D(latitude: 35, longitude: 35)

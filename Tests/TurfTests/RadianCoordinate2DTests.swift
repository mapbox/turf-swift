...
class RadianCoordinate2DTests: XCTestCase {
    ...
    func testCalculatesDirection() {
        let startCoordinate = TurfRadianCoordinate2D(latitude: 35, longitude: 35)
        let endCoordianate = TurfRadianCoordinate2D(latitude: -10, longitude: -10)
    ...
    func testCalculatesCoordinateFacingDirectionInDegrees() {
        let startCoordianate = TurfRadianCoordinate2D(latitude: 35, longitude: 35)

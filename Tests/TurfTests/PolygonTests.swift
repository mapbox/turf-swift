...
class PolygonTests: XCTestCase {
    ...
    func testDeprecatedPolygonFeature() {
    ...
    func testDeprecatedPolygonContains() {
    ...
    func testDeprecatedPolygonDoesNotContain() {
        let coordinate = CLLocationCoordinate2D(latitude: 44, longitude: -77)
        let polygon = Polygon([[
    ...
    func testDeprecatedPolygonDoesNotContainWithHole() {
        let coordinate = CLLocationCoordinate2D(latitude: 44, longitude: -77)
        let polygon = Polygon([
            [
                CLLocationCoordinate2D(latitude: 41, longitude: -81),
